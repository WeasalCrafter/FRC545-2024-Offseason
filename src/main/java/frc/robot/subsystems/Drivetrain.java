...
public class Drivetrain extends SubsystemBase {
	...
	public double encoderResolution = 1;
	...
	public Drivetrain(File directory) {
		...
		double angleConversionFactor = SwerveMath.calculateDegreesPerSteeringRotation((150 / 7) * encoderResolution); 

		// Motor conversion factor is (PI * WHEEL DIAMETER IN METERS) / (GEAR RATIO * ENCODER RESOLUTION).
		//  In this case the wheel diameter is 4 inches, which must be converted to meters to get meters/second.
		//  The gear ratio is 6.75 motor revolutions per wheel rotation.
		//  The encoder resolution per motor revolution is 1 per motor revolution.
		double driveConversionFactor = SwerveMath.calculateMetersPerRotation(Units.inchesToMeters(4), 6.75 * encoderResolution); //L1-8.14 L2-6.75 L3-6.12
	 ...
	 * @return Drive command.
	 */
	public Command simDriveOmegaCommand(DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier angularRotationX) {
		return run(() -> {
			// Make the robot move
			swerveDrive.drive(
